...
.pull-left[
We typically use **α = 0.05** as a cutoff in regression, BUT if we had set **α = 0.01**, which variable would not be considered ‘useful’ to the model?
...
- R version should appear in your console:

<br>

<center>

```{r echo=F, out.height=50, out.width=850}

knitr::include_graphics("docs_files/images/Rversion_in_console.png")
...
```{r echo=F, out.height=100, out.width=300}

knitr::include_graphics("docs_files/images/RStudio_Version_in_AboutRStudio.png")
